android开发-连接wifi
------------
###### 开发环境是android studio 相比eclipse会有一定的差异
#### 主页布局文件
```XML
...
```
我们要显示出scan到的wifi 列表 则我们需要再布局一个item文件
```XML
<?xml version="1.0" encoding="utf-8"?>
<RelativeLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <TextView
        ...
        android:layout_width="wrap_content"
        android:layout_height="wrap_content"
        android:layout_alignBottom="@+id/wifi_level"
        android:layout_marginBottom="14dp"
        android:layout_toRightOf="@+id/wifi_level"
...
```
item.xml文件里面 imageView用来动态显示wifi信号强弱的图标 另外一个用来显示wifi的ssid
#### 主要的java code
    首先是需要一个wifi辅助类 android里提供了很多wifi API 具体我就不一一介绍了 用相应的API写了一个辅助类
```Java
